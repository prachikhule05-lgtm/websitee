...
import { INSTAGRAM_URL, PHONE_URL, getWhatsAppLink } from "@/utils/whatsapp";
    ...
    <>
        ...
        {[
          {
            ...
            className: "bg-gradient-to-br from-[#833AB4] to-[#E1306C] hover:scale-110",
          ...
          },
          {
            ...
            className: "bg-[#25D366] hover:scale-110 animate-pulse-glow",
      ...
      >
        <div className="flex items-center divide-x divide-gray-100">
          <a
            href={PHONE_URL}
            className="flex-1 flex flex-col items-center gap-0.5 py-2.5 text-[#2563EB] hover:bg-blue-50 transition-colors"
          >
          ...
          <a
            ...
            className="flex-1 flex flex-col items-center gap-0.5 py-2.5 text-[#25D366] hover:bg-green-50 transition-colors"
          >
          ...
          <Link
            to="/booking"
            className="flex-1 flex flex-col items-center gap-0.5 py-2.5 bg-[#F97316] text-white hover:bg-[#EA580C] transition-colors"
          >

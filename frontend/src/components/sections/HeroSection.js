    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
        <div className="max-w-3xl">
          ...
          {/* Mobile-only: Social channel circle buttons — visible at top of page */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: 0.25 }}
            className="flex sm:hidden gap-4 mb-7 items-center"
          >
            {[
              {
              ...
              {
                href: PHONE_URL, label: "Call Us", target: "_self",
                bg: "bg-[#2563EB] shadow-[0_4px_16px_rgba(37,99,235,0.5)]",
                icon: <Phone className="w-6 h-6 text-white" />,
              },
              {
                href: getWhatsAppLink(), label: "WhatsApp", target: "_blank",
                bg: "bg-[#25D366] shadow-[0_4px_16px_rgba(37,211,102,0.5)]",
                icon: (
              ...
              },
              {
                ...
                bg: "bg-[#FF6B00] shadow-[0_4px_16px_rgba(255,107,0,0.5)]",
                icon: (
                  <span className="text-white font-extrabold text-base leading-none tracking-tight select-none">JD</span>
                ),
              },
            ].map((item, i) => (
              <motion.a
                ...
                className={`w-14 h-14 rounded-full flex items-center justify-center shadow-xl active:scale-90 transition-transform duration-100 ${item.bg}`}
              >
                {item.icon}
              </motion.a>
            ))}

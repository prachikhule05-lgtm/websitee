...
const steps = [
  ...
  },
  {
    ...
    highlight: "bg-orange-50 text-[#F97316]"
  },
  {
    step: "03",
  ...
  return (
    <section className="py-20 bg-[#F8FAFC]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="font-body text-sm font-semibold text-[#F97316] uppercase tracking-widest mb-2">Simple Process</p>
          <h2 className="font-heading text-3xl sm:text-4xl font-bold text-[#0F172A]">How It Works</h2>
          <p className="font-body text-base text-[#475569] mt-3 max-w-xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          {/* Connector line */}
          <div className="hidden md:block absolute top-16 left-[33%] right-[33%] h-0.5 bg-gradient-to-r from-[#2563EB] via-[#F97316] to-[#22C55E] opacity-30 z-0" />
          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              <p className="font-body text-sm text-[#475569] leading-relaxed">{step.description}</p>
            </motion.div>
          ))}
        </div>
        ...
        >
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <div className="bg-[#F97316] text-white text-xs font-bold px-4 py-2 rounded-full uppercase tracking-wide whitespace-nowrap">
              Pay After Service
            </div>
          </div>
        </motion.div>
